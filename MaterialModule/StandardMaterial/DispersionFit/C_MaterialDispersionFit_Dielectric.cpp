...
C_MaterialDispersionFit_Dielectric::C_MaterialDispersionFit_Dielectric() : C_ContainerDataBase(){
...
C_MaterialDispersionFit_Dielectric::~C_MaterialDispersionFit_Dielectric(){
}
...
/*-------------------------------------------------
		参数 - 获取装配方案
*/
QStringList C_MaterialDispersionFit_Dielectric::getTypeList_FittingScheme() {
	return QStringList() << QObject::tr("Conductivity") << QObject::tr("nth order");
}
/*-------------------------------------------------
		参数 - 获取数据类型
*/
QStringList C_MaterialDispersionFit_Dielectric::getTypeList_DataFormat() {
...
/*-------------------------------------------------
		参数 - 获取属性描述
*/
QString C_MaterialDispersionFit_Dielectric::getAttributesDesc() {
...
/*-------------------------------------------------
		访问器 - 获取子类类名
*/
QString C_MaterialDispersionFit_Dielectric::get__CLASS_NAME__(){
	return "C_MaterialDispersionFit_Dielectric";
}
/*-------------------------------------------------
		访问器 - 获取子类类名（中文名）
*/
QString C_MaterialDispersionFit_Dielectric::get__CLASS_NAME__Chinese(){
	return "材料属性-离散拟合-电导率";
}
/*-------------------------------------------------
		访问器 - 获取所有继承的类名
*/
QStringList C_MaterialDispersionFit_Dielectric::get__CLASS_INHERITED_LIST__(){
	return C_ContainerDataBase::get__CLASS_INHERITED_LIST__() << "C_MaterialDispersionFit_Dielectric";
}
/*-------------------------------------------------
		访问器 - 是否继承了某类
*/
bool C_MaterialDispersionFit_Dielectric::get__CLASS_IS_INSTANCE_OF__(QString class_name){
	return this->get__CLASS_INHERITED_LIST__().contains(class_name);
}
/*-------------------------------------------------
		访问器 - 原型复制对象
*/
C_MaterialDispersionFit_Dielectric C_MaterialDispersionFit_Dielectric::clone(){
	return C_MaterialDispersionFit_Dielectric(*this);
}
QSharedPointer<C_MaterialDispersionFit_Dielectric> C_MaterialDispersionFit_Dielectric::clonePtr(){
	return QSharedPointer<C_MaterialDispersionFit_Dielectric>(new C_MaterialDispersionFit_Dielectric(*this));
}

/*-------------------------------------------------
		复制对象
*/
void C_MaterialDispersionFit_Dielectric::copyFrom(C_MaterialDispersionFit_Dielectric* a){
...
/*-------------------------------------------------
		运算符重载
*/
const bool C_MaterialDispersionFit_Dielectric::operator== (const C_MaterialDispersionFit_Dielectric& a)const {
	return C_ContainerDataBase::operator==(a);
}
/*-------------------------------------------------
		空判断
*/
bool C_MaterialDispersionFit_Dielectric::isNull(){
...
/*-------------------------------------------------
		实体类 -> QJsonObject
*/
QJsonObject C_MaterialDispersionFit_Dielectric::getJsonObject_childData(){
	QJsonObject obj;
	...
	for (int i = 0; i < this->data_list.size(); i++) {
		C_MaterialDispersionFit_DielectricCell c = this->data_list.at(i);
...
/*-------------------------------------------------
		QJsonObject -> 实体类
*/
void C_MaterialDispersionFit_Dielectric::setJsonObject_childData(QJsonObject obj){
	...
	for (int i = 0; i < arr.size(); i++) {
		C_MaterialDispersionFit_DielectricCell c;
...
-----==========================================================-----
*/
C_MaterialDispersionFit_DielectricCell::C_MaterialDispersionFit_DielectricCell(){
...
/*-------------------------------------------------
		参数 - 计算并覆盖tand值
*/
void C_MaterialDispersionFit_DielectricCell::calculateTand() {
	this->value_tand = this->value_imag / this->value_real;
}
/*-------------------------------------------------
		参数 - 计算并覆盖imag值
*/
void C_MaterialDispersionFit_DielectricCell::calculateImag() {
...
/*-------------------------------------------------
		实体类 -> QJsonObject
*/
QJsonObject C_MaterialDispersionFit_DielectricCell::getJsonObject() {
	QJsonObject obj;
...
/*-------------------------------------------------
		QJsonObject -> 实体类
*/
void C_MaterialDispersionFit_DielectricCell::setJsonObject(QJsonObject obj) {
