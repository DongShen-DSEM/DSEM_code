...
class C_STD_MaterialDispersionFit_DielectricCell;
class C_STD_MaterialDispersionFit_Dielectric{

	public:
		C_STD_MaterialDispersionFit_Dielectric();
		~C_STD_MaterialDispersionFit_Dielectric();
	...
	public:
		...
		vector<C_STD_MaterialDispersionFit_DielectricCell> data_list;
	public:
										//参数 - 获取数据类型
...
class C_STD_MaterialDispersionFit_DielectricCell{
	...
	public:
		C_STD_MaterialDispersionFit_DielectricCell();
		~C_STD_MaterialDispersionFit_DielectricCell();
