#include "stdafx.h"
#include "C_STD_MaterialDispersionFit_Dielectric.h"


/*
-----==========================================================-----
		类：		材料属性-离散拟合-电导率 数据类（STD）.h
		作者：		drill_up
		所属模块：	材料模块
		功能：		材料的数据类对象。
-----==========================================================-----
...
C_STD_MaterialDispersionFit_Dielectric::C_STD_MaterialDispersionFit_Dielectric(){
...
/*-------------------------------------------------
		参数 - 获取装配方案
*/
vector<string> C_STD_MaterialDispersionFit_Dielectric::getTypeList_FittingScheme() {
...
/*-------------------------------------------------
		访问器 - 获取子类类名
*/
string C_STD_MaterialDispersionFit_Dielectric::get__CLASS_NAME__(){
	return "C_STD_MaterialDispersionFit_Dielectric";
}
/*-------------------------------------------------
		访问器 - 获取子类类名（中文名）
*/
string C_STD_MaterialDispersionFit_Dielectric::get__CLASS_NAME__Chinese(){
...
/*-------------------------------------------------
		QJsonObject -> 实体类
*/
void C_STD_MaterialDispersionFit_Dielectric::setJsonObject(const Value& obj){
	...
	for (int i = 0; i < arr.Size(); i++) {
		C_STD_MaterialDispersionFit_DielectricCell c;
...
-----==========================================================-----
*/
C_STD_MaterialDispersionFit_DielectricCell::C_STD_MaterialDispersionFit_DielectricCell(){
...
/*-------------------------------------------------
		参数 - 计算并覆盖tand值
*/
void C_STD_MaterialDispersionFit_DielectricCell::calculateTand() {
	this->value_tand = this->value_imag / this->value_real;
}
/*-------------------------------------------------
		参数 - 计算并覆盖imag值
*/
void C_STD_MaterialDispersionFit_DielectricCell::calculateImag() {
...
/*-------------------------------------------------
		QJsonObject -> 实体类
*/
void C_STD_MaterialDispersionFit_DielectricCell::setJsonObject(const Value& obj) {
